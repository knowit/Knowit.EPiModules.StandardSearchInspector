...
using Knowit.EPiModules.StandardSearchInspector.Business;
using Knowit.EPiModules.StandardSearchInspector.Models.ViewModels;

namespace Knowit.EPiModules.StandardSearchInspector.Controllers
{
    public class SearchModuleController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("/modules/Knowit.EPiModules.StandardSearchInspector/Views/SearchModule/Index.cshtml", model);
        }
        ...
        public ActionResult Search(string query = null, int page = 1)
        {
            ...
            return PartialView("/modules/Knowit.EPiModules.StandardSearchInspector/Views/SearchModule/_Result.cshtml", model);
        }
        ...
        public ActionResult SearchReindex() {
            ...
            return View("/modules/Knowit.EPiModules.StandardSearchInspector/Views/SearchModule/_Reindex.cshtml");
        }
